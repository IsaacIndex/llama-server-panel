...
export CHAT_MODEL="Mistral-Small-3.2-24B-Instruct-2506-BF16.gguf"
export CHAT_PORT="8080"
export CHAT_CTX_SIZE="128000"
...
export EMBED_CTX_SIZE="32000"
export EMBED_THREADS="8"
export EMBED_POOLING="mean"
export EMBED_BATCH_SIZE="8192"
export EMBED_UBATCH_SIZE="8192"
